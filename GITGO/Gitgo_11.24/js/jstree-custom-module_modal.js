...
$(document).ready(function () {
    ...
    <div class="list_inner main_list_wrap">
      <div class="list_inner_box">
        ...
        <div class="profile_txt">
          ...
          <p class="belong">
            <span class="tool-tip belong_team">개발팅</span>
            <span class="tool-tip belong_team belong_position">ㅣ차장</span>
          </p>
    ...
    <div class="list_inner popup_list_wrap">
      <div class="list_inner_box popup_list_inner">
        ...
        <div class="profile_txt">
          <p class="name tool-tip">홍길동</p>
          <p class="belong">
            <span class="tool-tip belong_team">개발팀</span>
            <span class="tool-tip belong_team belong_position">ㅣ차장</span>
          </p>
        </div>
      </div>
  ...
  const jsonData = [
    ...
    },
    {
      id: "node3",
      parent: "node2",
      text: `<span class="tree_text tree_name">영업팀</span> <span class="tree_text tree_count">[10]</span>
    ...
    },
    {
      id: "node5",
      parent: "node3",
      text: `<span class="tree_text tree_name">영업 2부서</span> <span class="tree_text tree_count">[4]</span>
    ...
    },
    {
      id: "node6",
      parent: "node3",
      text: `<span class="tree_text tree_name">영업 3부서</span> <span class="tree_text tree_count">[4]</span>
          <img class="groupCheckIcon" src=${groupSelectIcon} id="checkAll06" />
        `,
      li_attr: { "data-type": "Group" },
    },
    {
